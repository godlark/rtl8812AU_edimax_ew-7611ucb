...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE(USB_VENDER_ID_EDIMAX, 0xA812), .driver_info = RTL8821}, /* Edimax - Edimax */
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_EDIMAX, 0xB611, 0xff, 0xff, 0xff), .driver_info = RTL8821}, /* 8821AU */
	//EDX
